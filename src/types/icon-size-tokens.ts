...
export const DEFAULT_ICON_SIZE_SEMANTIC_TOKENS: IconSizeSemanticToken[] = [
  ...
  // ============================================
  { id: 'is-1', path: 'iconSize.interactive.buttonLarge', category: 'interactive', name: 'buttonLarge', desktop: '24', tablet: '24', mobile: '24', description: 'Large button icon' },
  ...
  { id: 'is-3', path: 'iconSize.interactive.buttonCompact', category: 'interactive', name: 'buttonCompact', desktop: '16', tablet: '16', mobile: '16', description: 'Compact button icon' },
  { id: 'is-4', path: 'iconSize.interactive.buttonIconOnly', category: 'interactive', name: 'buttonIconOnly', desktop: '24', tablet: '24', mobile: '24', description: 'Icon-only button' },
  ...
  { id: 'is-7', path: 'iconSize.interactive.linkCompact', category: 'interactive', name: 'linkCompact', desktop: '16', tablet: '16', mobile: '16', description: 'Compact link icon' },
  ...
  { id: 'is-9', path: 'iconSize.interactive.menuItemCompact', category: 'interactive', name: 'menuItemCompact', desktop: '16', tablet: '16', mobile: '16', description: 'Compact menu item icon' },
  { id: 'is-10', path: 'iconSize.interactive.tab', category: 'interactive', name: 'tab', desktop: '24', tablet: '24', mobile: '24', description: 'Tab icon' },
  ...
  { id: 'is-22', path: 'iconSize.form.inputAction', category: 'form', name: 'inputAction', desktop: '24', tablet: '24', mobile: '24', description: 'Input action icon' },
  ...
  { id: 'is-24', path: 'iconSize.form.clearButton', category: 'form', name: 'clearButton', desktop: '16', tablet: '16', mobile: '16', description: 'Clear button icon' },
  ...
  { id: 'is-27', path: 'iconSize.form.switch', category: 'form', name: 'switch', desktop: '16', tablet: '16', mobile: '16', description: 'Switch icon' },
  { id: 'is-28', path: 'iconSize.form.validation', category: 'form', name: 'validation', desktop: '16', tablet: '16', mobile: '16', description: 'Validation status icon' },
  { id: 'is-29', path: 'iconSize.form.required', category: 'form', name: 'required', desktop: '16', tablet: '16', mobile: '16', description: 'Required indicator' },

  // ============================================
  // NAVIGATION - breadcrumbs, pagination, arrows
  // ============================================
  { id: 'is-30', path: 'iconSize.navigation.item', category: 'navigation', name: 'item', desktop: '24', tablet: '24', mobile: '24', description: 'Navigation item icon' },
  ...
  { id: 'is-32', path: 'iconSize.navigation.breadcrumbSeparator', category: 'navigation', name: 'breadcrumbSeparator', desktop: '16', tablet: '16', mobile: '16', description: 'Breadcrumb separator' },
  ...
  { id: 'is-37', path: 'iconSize.navigation.menuArrow', category: 'navigation', name: 'menuArrow', desktop: '16', tablet: '16', mobile: '16', description: 'Menu arrow' },
  { id: 'is-38', path: 'iconSize.navigation.submenuArrow', category: 'navigation', name: 'submenuArrow', desktop: '16', tablet: '16', mobile: '16', description: 'Submenu arrow' },
  { id: 'is-39', path: 'iconSize.navigation.back', category: 'navigation', name: 'back', desktop: '24', tablet: '24', mobile: '24', description: 'Back navigation' },
  { id: 'is-40', path: 'iconSize.navigation.close', category: 'navigation', name: 'close', desktop: '24', tablet: '24', mobile: '24', description: 'Close icon' },
  ...
  // ============================================
  { id: 'is-50', path: 'iconSize.status.badge', category: 'status', name: 'badge', desktop: '16', tablet: '16', mobile: '16', description: 'Badge icon' },
  { id: 'is-51', path: 'iconSize.status.tag', category: 'status', name: 'tag', desktop: '16', tablet: '16', mobile: '16', description: 'Tag icon' },
  { id: 'is-52', path: 'iconSize.status.chip', category: 'status', name: 'chip', desktop: '16', tablet: '16', mobile: '16', description: 'Chip icon' },
  { id: 'is-53', path: 'iconSize.status.chipRemove', category: 'status', name: 'chipRemove', desktop: '16', tablet: '16', mobile: '16', description: 'Chip remove icon' },
  { id: 'is-54', path: 'iconSize.status.indicator', category: 'status', name: 'indicator', desktop: '16', tablet: '16', mobile: '16', description: 'Status indicator' },
  { id: 'is-55', path: 'iconSize.status.dot', category: 'status', name: 'dot', desktop: '16', tablet: '16', mobile: '16', description: 'Status dot' },

  // ============================================
  // NOTIFICATION - alerts, toasts, banners
  // ============================================
  { id: 'is-60', path: 'iconSize.notification.alert', category: 'notification', name: 'alert', desktop: '24', tablet: '24', mobile: '24', description: 'Alert icon' },
  ...
  { id: 'is-62', path: 'iconSize.notification.toast', category: 'notification', name: 'toast', desktop: '24', tablet: '24', mobile: '24', description: 'Toast icon' },
  ...
  { id: 'is-65', path: 'iconSize.notification.bannerClose', category: 'notification', name: 'bannerClose', desktop: '24', tablet: '24', mobile: '24', description: 'Banner close icon' },
  ...
  { id: 'is-71', path: 'iconSize.data.tableSort', category: 'data', name: 'tableSort', desktop: '16', tablet: '16', mobile: '16', description: 'Table sort icon' },
  ...
  { id: 'is-74', path: 'iconSize.data.metricInfo', category: 'data', name: 'metricInfo', desktop: '16', tablet: '16', mobile: '16', description: 'Metric info icon' },
  { id: 'is-75', path: 'iconSize.data.chartLegend', category: 'data', name: 'chartLegend', desktop: '16', tablet: '16', mobile: '16', description: 'Chart legend icon' },

  // ============================================
  // MEDIA - avatars, placeholders, players
  // ============================================
  { id: 'is-80', path: 'iconSize.media.avatarBadge', category: 'media', name: 'avatarBadge', desktop: '16', tablet: '16', mobile: '16', description: 'Avatar badge icon' },
  { id: 'is-81', path: 'iconSize.media.avatarStatus', category: 'media', name: 'avatarStatus', desktop: '16', tablet: '16', mobile: '16', description: 'Avatar status icon' },
  ...
  { id: 'is-87', path: 'iconSize.media.controlsCompact', category: 'media', name: 'controlsCompact', desktop: '24', tablet: '24', mobile: '24', description: 'Compact media controls' },

  // ============================================
  // EMPTY - empty states, illustrations
  // ============================================
  { id: 'is-90', path: 'iconSize.empty.illustration', category: 'empty', name: 'illustration', desktop: '64', tablet: '64', mobile: '64', description: 'Empty state illustration' },
  ...
  { id: 'is-92', path: 'iconSize.empty.icon', category: 'empty', name: 'icon', desktop: '48', tablet: '48', mobile: '48', description: 'Empty state icon' },
  { id: 'is-93', path: 'iconSize.empty.iconCompact', category: 'empty', name: 'iconCompact', desktop: '32', tablet: '32', mobile: '32', description: 'Compact empty state icon' },

  // ============================================
  // MODAL - dialogs, confirmations
  // ============================================
  { id: 'is-100', path: 'iconSize.modal.close', category: 'modal', name: 'close', desktop: '24', tablet: '24', mobile: '24', description: 'Modal close icon' },
  ...
  { id: 'is-102', path: 'iconSize.modal.confirmationIcon', category: 'modal', name: 'confirmationIcon', desktop: '48', tablet: '48', mobile: '48', description: 'Confirmation dialog icon' },
  ...
  { id: 'is-111', path: 'iconSize.card.action', category: 'card', name: 'action', desktop: '24', tablet: '24', mobile: '24', description: 'Card action icon' },
  { id: 'is-112', path: 'iconSize.card.meta', category: 'card', name: 'meta', desktop: '16', tablet: '16', mobile: '16', description: 'Card meta icon' },
  { id: 'is-113', path: 'iconSize.card.feature', category: 'card', name: 'feature', desktop: '32', tablet: '32', mobile: '32', description: 'Card feature icon' },

  // ============================================
  // LIST - list items
  // ============================================
  { id: 'is-120', path: 'iconSize.list.itemIcon', category: 'list', name: 'itemIcon', desktop: '24', tablet: '24', mobile: '24', description: 'List item icon' },
  ...
  { id: 'is-122', path: 'iconSize.list.bullet', category: 'list', name: 'bullet', desktop: '16', tablet: '16', mobile: '16', description: 'List bullet' },
  { id: 'is-123', path: 'iconSize.list.checkbox', category: 'list', name: 'checkbox', desktop: '24', tablet: '24', mobile: '24', description: 'List checkbox icon' },
  ...
  // ============================================
  { id: 'is-130', path: 'iconSize.action.primary', category: 'action', name: 'primary', desktop: '24', tablet: '24', mobile: '24', description: 'Primary action icon' },
  { id: 'is-131', path: 'iconSize.action.secondary', category: 'action', name: 'secondary', desktop: '24', tablet: '24', mobile: '24', description: 'Secondary action icon' },
  ...
  { id: 'is-134', path: 'iconSize.action.fabCompact', category: 'action', name: 'fabCompact', desktop: '24', tablet: '24', mobile: '24', description: 'Compact FAB icon' },
  ...
  { id: 'is-136', path: 'iconSize.action.more', category: 'action', name: 'more', desktop: '24', tablet: '24', mobile: '24', description: 'More actions icon' },

  // ============================================
  // LOADING - spinners, loaders
  // ============================================
  { id: 'is-140', path: 'iconSize.loading.spinner', category: 'loading', name: 'spinner', desktop: '24', tablet: '24', mobile: '24', description: 'Default spinner' },
  ...
  { id: 'is-144', path: 'iconSize.loading.page', category: 'loading', name: 'page', desktop: '48', tablet: '48', mobile: '48', description: 'Page loading spinner' },

  // ============================================
  // SPECIAL - logos, social, rating, stepper
  // ============================================
  { id: 'is-150', path: 'iconSize.special.logo', category: 'special', name: 'logo', desktop: '32', tablet: '32', mobile: '32', description: 'Logo icon' },
  ...
  { id: 'is-152', path: 'iconSize.special.logoLarge', category: 'special', name: 'logoLarge', desktop: '48', tablet: '48', mobile: '48', description: 'Large logo' },
  ...
  { id: 'is-154', path: 'iconSize.special.socialCompact', category: 'special', name: 'socialCompact', desktop: '24', tablet: '24', mobile: '24', description: 'Compact social icon' },
  { id: 'is-155', path: 'iconSize.special.rating', category: 'special', name: 'rating', desktop: '24', tablet: '24', mobile: '24', description: 'Rating star icon' },
  { id: 'is-156', path: 'iconSize.special.ratingCompact', category: 'special', name: 'ratingCompact', desktop: '16', tablet: '16', mobile: '16', description: 'Compact rating star' },
  { id: 'is-157', path: 'iconSize.special.step', category: 'special', name: 'step', desktop: '24', tablet: '24', mobile: '24', description: 'Stepper icon' },
  { id: 'is-158', path: 'iconSize.special.stepCompact', category: 'special', name: 'stepCompact', desktop: '24', tablet: '24', mobile: '24', description: 'Compact stepper icon' },
];
